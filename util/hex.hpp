...
/// \file hex.hpp \brief Utilities for hexagonal tiles
...
The `edge_mask` parameter is a 6-bit integer where the bits correspond to the six surrounding hexes of the center hex, starting from the one at (-1, -1) and moving clockwise:
