...
impl Keycode {
    ...
    pub fn try_from(vk: VirtualKeyCode) -> Result<Self, ()> {
        ...
        match vk {
            ...
            VirtualKeyCode::Multiply => Ok(PadMultiply),
            ...
            VirtualKeyCode::Subtract => Ok(PadMinus),
